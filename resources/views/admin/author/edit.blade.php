                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" placeholder="Nhập tên tác giả"
                                        value="{{ $author->name }}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('age') is-invalid @enderror"
                                        name="age" placeholder="Nhập tuổi" value="{{ $author->age }}" min="1" max="150">
                                    @error('age')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="information" class="form-control summernote @error('information') is-invalid @enderror" rows="6">{{ $author->information }}</textarea>
                                    @error('information')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="photoUpload-zone">
                                        <div class="photoUpload-detail" id="photoUpload-preview">
                                            <img class="rounded" src="{{ !empty($author->photo_path) ? $author->photo_path : asset('assets/noimage.jpg') }}" alt="Alt Photo">
                                        </div>
